...
desc 'Generate documentation for the product_documents extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'ProductDocumentsExtension'
...
desc 'Test the product_documents extension.'
...
namespace :test do
  desc 'Functional test the product_documents extension.'
  ...
  desc 'Unit test the product_documents extension.'
